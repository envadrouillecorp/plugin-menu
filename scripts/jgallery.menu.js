   ...
   changeLang:function(lang) {
      ...
      if(curr_lang == 'fr') {
         ...
         config.tr['list-plug'] = '<li id="face"><span class="img"><img src="./admin/pages/menu/css/plug01.png" /></span><span class="descr"><h2>Face Recognition</h2><p>This plugin allows you to recognize and search faces in your galleries.<br/><br/><i>This plugin is already shipped with the gallery.</i></p></span><div class="meta"><span class="icon"></span><span class="name">Facial recognition</span><span class="pdl"></span></div></li>'
               ...
               +'<li id="multilang"><span class="img"><img src="./admin/pages/menu/css/plug05.png" /></span><span class="descr"><h2>Multilang</h2><p>Allows you to write descriptions in multiple languages. <i>This plugin is currently active. Browse the demo and change the language of the gallery to see it in effect. You can install this plugin from your administration pannel.</i></p></span><div class="meta"><span class="icon"></span><span class="name">Multilang</span><span class="pdl"></span></div></li>';
